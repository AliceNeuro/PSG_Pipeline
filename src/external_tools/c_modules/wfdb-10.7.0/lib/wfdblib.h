...
/* DEFWFDB is the default value of the WFDB path if the WFDB environment
   ...
   If WFDB_NETFILES support is disabled, the string ". /wynton/home/leng/alice-albrecht/projects/wfdb/database" is
   usually sufficient for a default WFDB path, thus restricting the search for
   WFDB files to the current directory ("."), followed by /wynton/home/leng/alice-albrecht/projects/wfdb/database).
...
# define DEFWFDB	". /wynton/home/leng/alice-albrecht/projects/wfdb/database"
#else
# define DEFWFDB ". /wynton/home/leng/alice-albrecht/projects/wfdb/database http://physionet.org/physiobank/database"
#endif
