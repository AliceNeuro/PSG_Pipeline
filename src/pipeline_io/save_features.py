...
def save_features(config, row, extracted_features):
    ...
    psg_key = f"{config.dataset.name.lower()}_ses-{session}_sub-{sub_id}"
    results_path = Path(config.paths.extracted_features) / f"{psg_key}_extracted_features.csv"
...
def save_features_wide(config, row, extracted_features):
    ...
    psg_key = f"{config.dataset.name.lower()}_ses-{session}_sub-{sub_id}"
    results_path = Path(config.paths.extracted_features) / f"{psg_key}_extracted_features_wide.csv"
